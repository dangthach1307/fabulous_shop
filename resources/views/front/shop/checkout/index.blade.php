                                        ...
                                        <div class="box-border">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <input type="text" class="input form-control" name="last_name" id="last_name">
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-xs-12">
                                                    <label for="country" class="required">Country</label>
                                                    <input type="text" class="input form-control" name="country" id="country">
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-xs-12">
                                                    <label for="street_address" class="required">Street address</label>
                                                    <input type="text" class="input form-control" name="street_address" id="street_address">
                                                </div>
                                            </div>
                                            <!-- / .row -->
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    ...
                                                    <input class="input form-control" type="text" name="postcode_zip" id="postcode_zip">
                                                </div>
                                                <div class="col-sm-6">
                                                    <label for="town_city" class="required">Town/City</label>
                                                    <input class="input form-control" type="text" name="town_city" id="town_city">
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-sm-6">
                                            ...
                                            <div class="table-responsive">
                                                <div class="order-detail-content">
                                                    ...
                                                    <ul class="payment_check">
                                                        <li>
                                                            <label for="pc-direct">
                                                                <input type="radio" name="payment_type" class="payment-radio"
                                                                    id="pc-direct" value="direct">
                                                    ...
                                                    <div class="cart_checkout text-center">
                                                        <button class="button btn-lg btn_placeorder">Place Order</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
