                        ...
                        <div class="widget-content p-0">
                            <div class="widget-content-wrapper">
                                    ...
                                    <div class="btn-group">
                                        <a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                                            ...
                                            <img width="42" class="rounded-circle"
                                                src="front/images/avatars/{{ Auth::user()->avatar ?? 'default-avatar.png' }}"
                                                alt="">
                                ...
                                <div class="widget-content-left  ml-3 header-user-info">
                                    <div class="widget-heading">
                                        {{ Auth::user()->last_name . ' ' . Auth::user()->first_name ?? '' }} </div>
                        ...
                        <ul class="vertical-nav-menu">
                            ...
                            <li class="mm-active">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a
                                            href="{{ route('order.index') }}"class="{{ request()->segment(2) == 'order' ? 'mm-active' : '' }}">
                                            <i class="metismenu-icon"></i>Order
                                        </a>
                                    </li>
                                    <li>
                                        <a
                                            href="{{ route('product.index') }}"class="{{ request()->segment(2) == 'product' ? 'mm-active' : '' }}">
                                            <i class="metismenu-icon"></i>Product
                                        </a>
                                    </li>
                                    <li>
                                        <a
                                            href="{{ route('category.index') }}"class="{{ request()->segment(2) == 'category' ? 'mm-active' : '' }}">
                                            <i class="metismenu-icon"></i>Category
                                        </a>
                                    </li>
                                    <li>
                                        <a
                                            href="{{ route('brand.index') }}"class="{{ request()->segment(2) == 'brand' ? 'mm-active' : '' }}">
