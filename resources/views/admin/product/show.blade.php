                ...
                <div class="main-card mb-3 card">
                    <div class="card-body display_data">
                        ...
                        <div class="position-relative row form-group">
                            ...
                            <div class="col-md-9 col-xl-8">
                                <p><a href="{{ route('image.index', $product->id) }}">Manage images</a></p>
                            </div>
                        </div>

                        <div class="position-relative row form-group">
                            <label for="brand_id" class="col-md-3 text-md-right col-form-label">Product Attributes</label>
                            <div class="col-md-9 col-xl-8">
                                <p><a href="{{ route('attribute.index', $product->id) }}">Manage Attributes</a></p>
                            </div>
                        </div>
