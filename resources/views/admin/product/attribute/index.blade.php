        ...
        <div class="app-page-title">
            <div class="page-title-wrapper">
                ...
                <div class="page-title-actions">
                    <a href="{{ route('attribute.create', $product->id) }}"
                            ...
                            <tbody>
                                @foreach ($productAttributes as $attribute)
                                    <tr>
                                        ...
                                        <td class="">{{ $attribute->qty }}</td>

                                        <td class="text-center">
                                            <a href="{{ route('attribute.edit', [$product->id, $attribute->id]) }}"
                                            ...
                                            <form class="d-inline"
                                                action="{{ route('attribute.destroy', [$product->id, $attribute->id]) }}"
                                                method="post">
                                                @csrf
                                                @method('DELETE')
